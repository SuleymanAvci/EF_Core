...
namespace CCore_16_Logs.Configurations
{
    public class PersonData : IEntityTypeConfiguration<Person>
    {
        public void Configure(EntityTypeBuilder<Person> builder)
        {
            builder.HasData(new Person[]
            {
              ...
              new(){ PersonId  = 2, Name = "Hilmi" ,IsActive=true},
              new(){ PersonId  = 3, Name = "Raziye" ,IsActive=true},
              new(){ PersonId  = 4, Name = "Süleyman" ,IsActive=true},
              new(){ PersonId  = 5, Name = "Fadime" ,IsActive=true},
              new(){ PersonId  = 6, Name = "Şuayip" , IsActive = true},
              new(){ PersonId  = 7, Name = "Lale" , IsActive = true},
              new(){ PersonId  = 8, Name = "Jale" , IsActive = true},
              new(){ PersonId  = 9, Name = "Rıfkı" , IsActive = true},
              new(){ PersonId  = 10, Name = "Muaviye" , IsActive = true},
            });
        }   
    }
